...
class MoveAnalyser
{
    ...
    MoveEffect getEffect(byte effByte)
    {
        ...
        {
            case (byte) 0x01:
                return MoveEffect.CAUSE_SLP;
            case (byte) 0x07:
                return MoveEffect.EXPLODE;
            case (byte) 0x08:
                return MoveEffect.DREAM_EATER;
            case (byte) 0x0A:
                return MoveEffect.ATKUP1;
            case (byte) 0x0B:
                return MoveEffect.DEFUP1;
            case (byte) 0x0C:
                return MoveEffect.SPDUP1;
            case (byte) 0x0D:
                return MoveEffect.SATKUP1;
            case (byte) 0x10:
                return MoveEffect.EVAUP1;
            case (byte) 0x11:
                return MoveEffect.NEVER_MISS;
            case (byte) 0x12:
                return MoveEffect.ATKDOWN1;
            case (byte) 0x13:
                return MoveEffect.DEFDOWN1;
            case (byte) 0x14:
                return MoveEffect.SPDDOWN1;
            case (byte) 0x15:
                return MoveEffect.SATKDOWN1;
            case (byte) 0x16:
                return MoveEffect.SDEFDOWN1;
            case (byte) 0x17:
                return MoveEffect.ACCDOWN1;
            case (byte) 0x18:
                return MoveEffect.EVADOWN1;
            case (byte) 0x1A:
                return MoveEffect.BIDE;
            case (byte) 0x1D:
                return MoveEffect.MULTI_HIT;
            case (byte) 0x20:
                return MoveEffect.RECOVER_REST;
            case (byte) 0x21:
                return MoveEffect.CAUSE_TOXIC;
            case (byte) 0x23:
                return MoveEffect.LIGHT_SCREEN;
            case (byte) 0x26:
                return MoveEffect.OHKO;
            case (byte) 0x27:
                return MoveEffect.RAZOR_WIND;
            case (byte) 0x28:
                return MoveEffect.HALVE_HP;
            case (byte) 0x29:
                return MoveEffect.FIXED_DAMAGE;
            case (byte) 0x2C:
                return MoveEffect.TWO_HITS;
            case (byte) 0x31:
                return MoveEffect.CAUSE_CNF;
            case (byte) 0x32:
                return MoveEffect.ATKUP2;
            case (byte) 0x33:
                return MoveEffect.DEFUP2;
            case (byte) 0x34:
                return MoveEffect.SPDUP2;
            case (byte) 0x35:
                return MoveEffect.SATKUP2;
            case (byte) 0x36:
                return MoveEffect.SDEFUP2;
            case (byte) 0x41:
                return MoveEffect.REFLECT;
            case (byte) 0x42:
                return MoveEffect.CAUSE_PSN;
            case (byte) 0x43:
                return MoveEffect.CAUSE_PRZ;
            case (byte) 0x4B:
                return MoveEffect.SKY_ATTACK;
            case (byte) 0x4D:
                return MoveEffect.TWO_HITS_PSN;
            case (byte) 0x50:
                return MoveEffect.RECHARGE;
            case (byte) 0x52:
                return MoveEffect.MIMIC;
            case (byte) 0x54:
                return MoveEffect.LEECH_SEED;
            case (byte) 0x57:
                return MoveEffect.LVL_DAMAGE;
            case (byte) 0x58:
                return MoveEffect.RND_DAMAGE;
            case (byte) 0x59:
                return MoveEffect.COUNTER;
            case (byte) 0x5A:
                return MoveEffect.ENCORE;
            case (byte) 0x5C:
                return MoveEffect.SNORE;
            case (byte) 0x5E:
                return MoveEffect.LOCK_ON;
            case (byte) 0x61:
                return MoveEffect.SLEEP_TALK;
            case (byte) 0x63:
                return MoveEffect.REVERSAL;
            case (byte) 0x64:
                return MoveEffect.DISABLE;
            case (byte) 0x66:
                return MoveEffect.HEAL_BELL;
            case (byte) 0x67:
            ...
            case (byte) 0x6D:
                return MoveEffect.CURSE;
            case (byte) 0x6F:
                return MoveEffect.PROTECT;
            case (byte) 0x70:
                return MoveEffect.SPIKES;
            case (byte) 0x72:
                return MoveEffect.PERISH_SONG;
            case (byte) 0x73:
                return MoveEffect.SANDSTORM;
            case (byte) 0x74:
                return MoveEffect.ENDURE;
            case (byte) 0x76:
                return MoveEffect.SWAGGER;
            case (byte) 0x78:
                return MoveEffect.ATTRACT;
            case (byte) 0x79:
                return MoveEffect.RETURN;
            case (byte) 0x7A:
                return MoveEffect.PRESENT;
            case (byte) 0x7B:
                return MoveEffect.FRUSTRATION;
            case (byte) 0x7E:
                return MoveEffect.MAGNITUDE;
            case (byte) 0x84:
                return MoveEffect.MORNING_SUN;
            case (byte) 0x85:
                return MoveEffect.SYNTHESIS;
            case (byte) 0x86:
                return MoveEffect.MOONLIGHT;
            case (byte) 0x87:
                return MoveEffect.HIDDEN_PWR;
            case (byte) 0x88:
                return MoveEffect.RAIN_DANCE;
            case (byte) 0x89:
                return MoveEffect.SUNNY_DAY;
            case (byte) 0x8E:
                return MoveEffect.BELLY_DRUM;
            case (byte) 0x8F:
                return MoveEffect.PSYCH_UP;
            case (byte) 0x90:
                return MoveEffect.MIRROR_COAT;
            case (byte) 0x94:
                return MoveEffect.FUTURE_SIGHT;
            case (byte) 0x97:
                return MoveEffect.SOLARBEAM;
            case (byte) 0x99:
                return MoveEffect.TELEPORT;
            case (byte) 0x9B:
                return MoveEffect.FLY_DIG;
            default:
                return MoveEffect.NO_EFFECT;
        }
    }

    public static Comparator<Move> MovePowerCmp = (Move m1, Move m2) ->
    {
    ...
    public static Comparator<Move> MoveTierCmp = (Move m1, Move m2) ->
    {
    ...
    {
        ArrayList<Move> movesPhy = new ArrayList<>();
    ...
    {
        ArrayList<Move> movesSpe = new ArrayList<>();
    ...
    {
        ArrayList<Move> movesSta = new ArrayList<>();
    ...
    protected boolean isSupportMove(Move move)
    {
        ...
        return ((eff == MoveEffect.CAUSE_SLP)
